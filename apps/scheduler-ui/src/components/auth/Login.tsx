...
const Login = ({setPage})  => {
    ...
    // return (
    //    <>
    //     <div sx={sx.'login-signup-container'>
    //         <Spinner />
    ...
    //             <button type="button" sx={sx.'link-btn' style={{width: 'fit-content', fontStyle: 'italic', fontSize: '16px',}}>Click Here to Signup</button>
    //         </div>
    //         <div sx={sx."form-container" style={{marginTop: '0'}}>
    //             <form>
    //                 <>
    //                     <div style={{padding: '25px'}}>
    //                         <div sx={sx."input-name" id='loginEmail'>
    //                             <h3>Email</h3>
    //                         </div>
    //                         <input
    //                             sx={sx."field-input"
    ...
    //                             autoFocus
    //                         />
    //                         <div sx={sx."input-name input-margin">
    //                             <h3>Password</h3>
    //                         </div>
    //                         <input
    //                             sx={sx."field-input"
    ...
    //                         <button type='button' sx={sx."submit-btn login-signup-title" onClick={handleSubmit} style={{width: '150px', margin: 'auto'}}>
    //                             Submit
    //                         </button>
    //                     </div>
    //                     <div sx={sx."forgot-pass"
    //                         style={{cursor: 'pointer'}}
    //                         onClick={handleForgot}
    //                     >
    //                         <button type='button' sx={sx.'link-btn' style={{cursor: 'pointer', fontStyle: 'italic', fontSize: '16px', marginTop: '15px'}}>Change/Forgot Password</button>
    //                     </div>
    //                 </>
    //             </form>
    //         </div>
