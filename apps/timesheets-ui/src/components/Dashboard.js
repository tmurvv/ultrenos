...
function Dashboard({setPage}) {
    ...
    const handleSubmitPrivileges = async (e) => {
        ...
        try {
            ...
            await axios.post(`https://timesheets-staging-api.ultrenos.ca/api/v1/ultrenostimesheets/users/updateuser`, updateObject)
    ...
    const handleSubmitDelete = async (e) => {
        ...
        try {
            if (document.querySelector('#spinner')) document.querySelector('#spinner').style.display="flex";
            await axios.post(`https://timesheets-staging-api.ultrenos.ca/api/v1/ultrenostimesheets/users/deleteuser`, deleteObject)
                            ...
                            <div style={{padding: '30px', display: 'flex', flexDirection: 'column', flex: '3', alignItems: 'center', justifyContent: 'center', textAlign: 'center'}}>
                                ...
                                <div style={{marginTop: '25px', width: '100%', display: 'flex', justifyContent: 'center'}}>
                                    <button type='button' className="submit-btn login-signup-title" style={{boxShadow: '3px 3px 3px lightgrey', width: '150px', margin: 'auto', backgroundColor: '#004976'}} onClick={()=>{if (!window.navigator.onLine) {window.alert('No network connection.')}}}>
                                        <a href={`https://timesheets-staging-api.ultrenos.ca/api/v1/ultrenostimesheets/admin/downloadnewtimesheets`} onClick={()=>setPage('Homepage')} style={{textDecoration: 'none', fontFamily: 'sans-serif', letterSpacing: '2px', fontSize: '14px', color: 'white'}}>Download</a>
                                    </button>
                                </div>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: '3'}}>
                                ...
                                <div style={{width: '100%', marginTop: '25px', display: 'flex', justifyContent: 'center'}}>
                                    <button type='button' className="submit-btn login-signup-title" style={{boxShadow: '3px 3px 3px lightgrey', width: '150px', margin: 'auto', backgroundColor: '#004976'}} onClick={()=>{if (!window.navigator.onLine) {window.alert('No network connection.')}}}>
                                        <a href={`https://timesheets-staging-api.ultrenos.ca/api/v1/ultrenostimesheets/admin/downloadalltimesheets`} onClick={()=>setPage('Homepage')} style={{textDecoration: 'none', fontFamily: 'sans-serif', letterSpacing: '2px', fontSize: '14px', color: 'white'}}>Download</a>
                                    </button>
                                </div>
                            </div>  
                        </div>
